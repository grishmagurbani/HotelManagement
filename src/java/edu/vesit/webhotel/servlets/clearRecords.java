...
public class clearRecords extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
        System.out.println("insideclear");
        ...
        if(!phoneno.equals("") )
        {
            System.out.println("HAppy?");
             st=bDAO.recordsClear(phoneno);
             if(st)
             {
            request.setAttribute("message","Cleared Successfully.");
        //  response.sendRedirect("Login.jsp");
            request.getRequestDispatcher("VisitorManagement.jsp").forward(request, response);
             ...
             {
            request.setAttribute("message","No Record Found to Delete.");
        //  response.sendRedirect("Login.jsp");
            request.getRequestDispatcher("VisitorManagement.jsp").forward(request, response);
        ...
        else
        {
            ...
            request.setAttribute("message","Enter Phoneno.");
        //  response.sendRedirect("Login.jsp");
            request.getRequestDispatcher("VisitorManagement.jsp").forward(request, response);
